...
export const Login: React.FC = () => {
   ...
   *
   * The session exists only inside the browser's sessionStorage
   * so the portfolio demo can show protected pages.
   */
  ...
  const handleDemoLogin = (role: 'player' | 'admin') => {
    ...
    // Create temporary browser-only demo session.
  ...
  const handleEmailDemoLogin = (
    e: React.FormEvent<HTMLFormElement>
  ) => {
    e.preventDefault();

    /*
     * The email and password are intentionally ignored.
     *
     * This is a portfolio demo.
     * They are not sent anywhere and are not stored.
     */
  ...
  const handleGoogleDemoLogin = () => {
    /*
     * This button visually represents Google login.
     * It does NOT connect to Google.
     */
    ...
    <div className="max-w-md mx-auto px-4 py-12 space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-gray-400">
          Explore the player dashboard, tournaments,
          matches and admin interface.
        </p>
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] leading-relaxed text-gray-300">
                ...
                <strong className="text-white">
                  {' '}
                  No real account, password, email, or personal
                  data is stored.
                </strong>
              </p>
        ...
        >
          ...
          <div>
            ...
            <p className="text-[9px] text-gray-600 mt-1">
              Optional. Used only for the visual demonstration.
            </p>
          ...
          <div>
            ...
            <p className="text-[9px] text-gray-600 mt-1">
              No password is validated, transmitted, or stored.
            </p>
